...
<head>
    ...
    <style>
        ...
        .brand { color: #9f3a22; font-size: 34px; margin: 0 0 4px; }
        ...
        .card { border: 1px solid #dfd2c4; border-radius: 10px; overflow: hidden; height: 344px; }
        .card img { display: block; width: 100%; height: 266px; object-fit: cover; }
...
<body>
    ...
    @foreach($sections as $section)
        @foreach($section['products']->chunk(4) as $pageIndex => $products)
            <div class="page" @if($pageIndex === 0) id="section-{{ $section['key'] }}" @endif>

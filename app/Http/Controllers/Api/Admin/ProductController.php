...
class ProductController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        $products = Product::query()
            ...
            ->when($request->filled('product_type'), fn ($query) => $query->where('product_type', $request->string('product_type')->toString()))
            ->when($request->filled('availability'), fn ($query) => $query->where('availability', $request->string('availability')->toString()))
    ...
    protected function transformProduct(Product $product, bool $detailed = false): array
    {
        $payload = [
            ...
            'brand_price' => $product->brand_price !== null ? (float) $product->brand_price : null,
        ...
        $payload['supplier'] = $product->supplier?->name;
        $payload['city'] = $product->city?->name;
